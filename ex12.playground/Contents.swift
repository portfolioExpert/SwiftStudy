...
printMyName4(hero: "홍길동", actor: "변사또")//별칭으로 넣어준다.

//가변 매개변수 - 매개변수를 배열로 입력할 수 있음.
func printMyName5(name1: String, name2: String...){//...은 여러개를 입력 받는 것
    print("name1: \(name1) name2: \(name2)")
    for name in name2{
        print(name)
    }
